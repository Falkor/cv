% Time-stamp: <Lun 2013-12-02 15:54 svarrette>
% ===============================================================================
...
\begin{rubriquetableau}[\offsetintab]{Professional Development}
    ...
    & \textbf{Cumulative Project Investment: 5.6 M\euro{}} {\small (as of 2013)}.\\
    & \offset \offset 291 computing nodes, 2944 cores, $R_{\text{peak}} =  27.36$ TFlops\\
    & \offset \offset 132 servers (74,6\% are Xen VMs)\\
    & \offset \offset NFS and Lustre Storage (Total raw capacity: 1044TB)\\
    & \offset \offset 3 system administrators + 1 student assistant\\
    & \\
