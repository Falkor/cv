% Time-stamp: <Sun 2018-04-08 00:09 svarrette>
% ===============================================================================
...
\begin{rubriquetableau}[\offsetintab]{Graduate Students Supervision}
  ...
  \\
  \ifSmallOrShort{
    \emph{In addition:} & 13 master and 4 bachelor students supervision for
  ...
  \iffullcv{
    ...
    \textbf{Master}
    &
    \supervision{Clément Parisot}{2017 --}{System administrator of the
