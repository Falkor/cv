% Time-stamp: <Tue 2020-01-07 10:36 svarrette>
% ===============================================================================
...
\begin{rubriquetableau}[\offsetintab]{Graduate Students Supervision}
  ...
  \\
  \ifSmallOrShort{
    \emph{In addition:} & 19 master and 5 bachelor students supervision for
  ...
  \iffullcv{
    ...
    \supervision{Cl\'ement Courageux-Sudan}{2019}{Blockchains environments to support IoT
      developments Overview and Open Challenges (ENS)} \\
    &
