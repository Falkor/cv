% Time-stamp: <Tue 2012-03-06 23:06 svarrette>
% ==============================================================================
...
\begin{rubrique}{Publications}
    ...
    {\footnotesize
      ...
      \begin{tabular}{|cccccc|}
          \hline
          Papers:35    & Citations:116  & Years:10     & h-index:7    & g-index:9 & hc-index:4,hI-index:2.23,hI-norm:4
          \\
          & AWCR:16.86 & AW-index:4.11 & AWCRpA:6.33 & e-index:5.29 & hm-index:3.95,"\textbf{2012-03-06}"
          \\
          \hline
      \end{tabular}
    }
