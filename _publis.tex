% Time-stamp: <Tue 2012-05-22 00:18 svarrette>
% ==============================================================================
...
\begin{rubrique}{Publications}
    ...
    {\footnotesize
      ...
      \begin{tabular}{|cccccc|}
          \hline
          Papers:45    & Citations:132  & Years:10     & h-index:7    & g-index:9 & hc-index:4,hI-index:2.23,hI-norm:4
          \\
          & AWCR:19.12 & AW-index:4.37 & AWCRpA:7.39 & e-index:5.39 & hm-index:3.95,"\textbf{2012-05-22}"
          \\
          \hline
      \end{tabular}
    }
