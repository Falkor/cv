% Time-stamp: <Mer 2013-10-16 10:28 svarrette>
% ==============================================================================
...
\vspace{1em}
\begin{tabular}{ll}
    \textsc{Engineer Expertise:} & \acf{HPC}, Grid, Cluster \& Cloud Platforms.
    \\
    ...
    & \offset $\bullet$ Performance evaluation \& Energy efficiency of HPC/Cloud platforms \cvcite{DVB_SPECTS08,DVB_PPAM09,GVPSB_EELSDS13,JVOB_EELSDS13} \\
