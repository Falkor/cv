% Time-stamp: <Tue 2021-08-31 11:38 svarrette>
% ==============================================================================
...
\begin{chapeau}
  \begin{adresse}
    ...
    \ligne\\
    \textbf{Research Scientist, Head UL HPC \& Big Data Digital Platforms}\\
...
\begin{tabular}{ll}
  ...
  \textsc{Books} \ifShortOrFull{\cite{VB_Prog_C07,DRTV_FoundationCoding15,DRTV_ThCode18,DLTV_Blockchains19}}:
                                  &\\
                                  & \vspace*{-1em}
