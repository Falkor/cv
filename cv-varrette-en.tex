% Time-stamp: <Mon 2022-02-07 10:10 svarrette>
% ==============================================================================
...
\begin{chapeau}
  \begin{adresse}
    ...
    E-mail:    \url{Sebastien.Varrette@gmail.com}\\
    Home page: \url{http://varrette.gforge.uni.lu}\\
    GPG Key ID: \href{https://keyserver.ubuntu.com/pks/lookup?search=0x5D08BCDD4F156AD7&fingerprint=on&op=index}{5D08BCDD4F156AD7}
  \end{adresse}
  \begin{etatcivil}
